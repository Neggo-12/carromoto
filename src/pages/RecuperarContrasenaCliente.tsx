...
import { Mail, ArrowLeft, MailCheck, UserCircle } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="rounded-3xl border border-black/[0.06] bg-white p-7 shadow-xl sm:p-9">
        {!enviado ? (
          <>
            <Link to="/login/cliente" className="mb-5 inline-flex items-center gap-1.5 text-xs font-semibold text-muted-foreground hover:text-foreground transition-colors">
