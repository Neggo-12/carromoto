  ...
  return (
    ...
    >
      <div className="rounded-3xl border border-black/[0.06] bg-white p-7 shadow-xl sm:p-9">
        {!enviado ? (
          <>
            <Link to="/login" className="mb-5 inline-flex items-center gap-1.5 text-xs font-semibold text-muted-foreground hover:text-foreground transition-colors">
            ...
            <form onSubmit={handleSubmit} className="mt-7 space-y-4">
              <TextField
                ...
                required
              />
              <Button as="button" type="submit" variant="brand" size="lg" className="w-full">
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
              Si <span className="font-semibold text-foreground">{email}</span> tiene una cuenta con nosotros,
